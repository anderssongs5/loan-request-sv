...
public class ApprovedLoanReportSQSSenderConfig {

    @Bean
    public SqsAsyncClient configSqs(ApprovedLoanReportSQSSenderProperties properties, MetricPublisher publisher) {
